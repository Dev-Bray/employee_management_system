...
lbldob = Label(entries_frame, text="D.O.J", font=("Arial", 16), bg="#535c68", fg="white")
lbldob.grid(row=2, column=0, padx=10, pady=10, sticky="w")
txtdob = Entry(entries_frame, textvariable=dob, font=("Arial", 16), width=30)
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Arial", 16, "bold"), fg="white",
                bg="#16a085", bd=0).grid(row=0, column=0)
btnEdit = Button(btn_frame, command=update_employee, text="Update Details", width=15, font=("Arial", 16, "bold"),
                 fg="white", bg="#2980b9",
                 bd=0).grid(row=0, column=1, padx=10)
btnDelete = Button(btn_frame, command=delete_employee, text="Delete Details", width=15, font=("Arial", 16, "bold"),
                   fg="white", bg="#c0392b",
                   bd=0).grid(row=0, column=2, padx=10)
btnClear = Button(btn_frame, command=clearAll, text="Clear Details", width=15, font=("Arial", 16, "bold"), fg="white",
                  bg="#f39c12",
